# Romanize: Takes a number and translate it to the roman number system
#
# number - Input given by the user
# output - The string the will be returned
# numbers - An hash with different numbers pointing at different letters
#
# Examples
#
#   romanize(510)
...
def romanize(number)
    ...
    output = '' #Creates a new variable he will return a string to the user
